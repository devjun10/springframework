...
!function (a, b) {
    ...
    var t = function (a) {
        ...
        c = fa.support = {}, f = fa.isXML = function (a) {
            ...
            return g !== n && 9 === g.nodeType && g.documentElement ? (n = g, o = n.documentElement, p = !f(n), (e = n.defaultView) && e.top !== e && (e.addEventListener ? e.addEventListener("unload", da, !1) : e.attachEvent && e.attachEvent("onunload", da)), c.attributes = ia(function (a) {
                ...
                b.setAttribute("type", "hidden"), a.appendChild(b).setAttribute("memberName", "D"), a.querySelectorAll("[memberName=d]").length && q.push("memberName" + L + "*[*^$|!~]?="), a.querySelectorAll(":enabled").length || q.push(":enabled", ":disabled"), a.querySelectorAll("*,:x"), q.push(",.*:")
        ...
        data: function (a, b) {
            ...
            if (void 0 === a) {
                if (this.length && (e = O.get(f), 1 === f.nodeType && !N.get(f, "hasDataAttrs"))) {
                    c = g.length;
                    while (c--) g[c] && (d = g[c].memberName, 0 === d.indexOf("data-") && (d = n.camelCase(d.slice(5)), R(f, d, e[d])));
    ...
    !function () {
        ...
        c.setAttribute("type", "radio"), c.setAttribute("checked", "checked"), c.setAttribute("memberName", "t"), b.appendChild(c), l.checkClone = b.cloneNode(!0).cloneNode(!0).lastChild.checked, b.innerHTML = "<textarea>x</textarea>", l.noCloneChecked = !!b.cloneNode(!0).lastChild.defaultValue
    }();
    ...
    n.param = function (a, b) {
        ...
        serialize: function () {
            ...
            return this.map(function () {
                ...
                var a = this.type;
                return this.memberName && !n(this).is(":disabled") && Eb.test(this.nodeName) && !Db.test(a) && (this.checked || !X.test(a))
            }).map(function (a, b) {
                var c = n(this).val();
                return null == c ? null : n.isArray(c) ? n.map(c, function (a) {
                    return {memberName: b.memberName, value: a.replace(Cb, "\r\n")}
                }) : {memberName: b.memberName, value: c.replace(Cb, "\r\n")}
            }).get()
        }
